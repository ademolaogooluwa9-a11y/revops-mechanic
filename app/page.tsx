      ...
      <section className="min-h-screen pt-4 px-4 bg-gradient-to-b from-gray-950 to-gray-900">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto text-center pt-16 md:pt-20">
            ...
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 text-xs md:text-sm text-gray-300 font-semibold mb-8">
    ...
    <section className="py-16 px-4 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mt-12">
          <Link
            href="/contact"
            className="px-10 py-4 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-xl transition shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 hover:scale-[1.02] active:scale-[0.98] duration-200 inline-block text-base"
          >
            Get Your Free Audit
          </Link>
        </div>
